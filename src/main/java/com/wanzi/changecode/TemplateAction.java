...
import com.wanzi.changecode.templateaction.TemplateListPopupStep;
...
public class TemplateAction extends AnAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent event) {
        // 创建列表弹出窗口
        ListPopup listPopup = JBPopupFactory.getInstance().createListPopup(new TemplateListPopupStep(event));
        // 在屏幕中间显示列表弹出窗口
