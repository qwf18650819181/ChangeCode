...
import com.wanzi.changecode.singletonaction.GenerateType;
import com.wanzi.changecode.singletonaction.ShowDialog;
...
//        e.getPresentation().setEnabled(editor != null);
            if (isSourceFolder)
                e.getPresentation().setIcon(IconLoader.getIcon("singletonaction/icon.jpg"));
//                try {
